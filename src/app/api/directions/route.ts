...
/**
 * MinervaAI — Turn-by-turn Directions API
 *
...
/** Minimal shapes of the upstream payloads — only the fields MinervaAI reads. */
...
export async function GET(request: Request) {
  try {
    ...
    console.error('[MinervaAI] Directions error:', error);
